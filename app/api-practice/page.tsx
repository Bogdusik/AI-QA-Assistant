      ...
      <Section title="HTTP methods (GET / POST / PUT / DELETE)">
        <div className="grid gap-4 md:grid-cols-2">
          <Card className="space-y-2">
            ...
            <p className="text-sm text-slate-600">Read data. Should not change server state.</p>
          </Card>
          <Card className="space-y-2">
      ...
      <Section title="Postman requests (real endpoints)">
        <div className="space-y-6">
          <Card className="space-y-3">
            <h3 className="font-semibold text-lg">1) Register user</h3>
            <p className="text-sm text-slate-600">
...
{ "error": "Invalid registration data." }`}
            ...
            <p className="text-sm font-medium">What to verify (QA)</p>
  ...
  "documents": [
    {
      ...
      "createdAt": "..."
          ...
          <Card className="space-y-3">
            <h3 className="font-semibold text-lg">4) Generate a document (QA generation)</h3>
            <p className="text-sm text-slate-600">
    ...
    "explainability": { "...": "..." }
      ...
      <Section title="Suggested Postman test scenarios">
        <div className="space-y-4">
          <Card className="space-y-2">
            <p className="font-semibold">POST /api/register</p>
            <ul className="list-disc pl-5 text-sm text-slate-700">
          ...
          <Card className="space-y-2">
            <p className="font-semibold">POST /api/generate</p>
            <ul className="list-disc pl-5 text-sm text-slate-700">
          ...
          <Card className="space-y-2">
            <p className="font-semibold">GET /api/documents</p>
            <ul className="list-disc pl-5 text-sm text-slate-700">
          ...
          <Card className="space-y-2">
            <p className="font-semibold">GET /api/documents/{`{documentId}`}/export</p>
            <ul className="list-disc pl-5 text-sm text-slate-700">
          ...
          <Card className="space-y-2">
            <p className="font-semibold">POST /api/documents/{`{documentId}`}/quality-analysis</p>
            <ul className="list-disc pl-5 text-sm text-slate-700">
